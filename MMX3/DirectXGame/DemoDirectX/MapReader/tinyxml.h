...
public:
	...
	*/
	...
	const TiXmlElement* ToElement() const override { return this; }
...
public:
	...
	*/
	...
	const TiXmlComment* ToComment() const override { return this; }
	///< Cast to a more defined type. Will return null not of the requested type.
	TiXmlComment* ToComment() override { return this; }
	///< Cast to a more defined type. Will return null not of the requested type.
...
public:
	...
	*/
	...
	const TiXmlText* ToText() const override { return this; }
	///< Cast to a more defined type. Will return null not of the requested type.
...
public:
	...
	const TiXmlDeclaration* ToDeclaration() const override { return this; }
	///< Cast to a more defined type. Will return null not of the requested type.
	TiXmlDeclaration* ToDeclaration() override { return this; }
	///< Cast to a more defined type. Will return null not of the requested type.
...
public:
	...
	const TiXmlUnknown* ToUnknown() const override { return this; }
	///< Cast to a more defined type. Will return null not of the requested type.
	TiXmlUnknown* ToUnknown() override { return this; }
	///< Cast to a more defined type. Will return null not of the requested type.
...
public:
	...
	*/
	const char* Parse(const char* p, TiXmlParsingData* data = nullptr,
	...
	*/
	...
	const TiXmlDocument* ToDocument() const override { return this; }
	///< Cast to a more defined type. Will return null not of the requested type.
	TiXmlDocument* ToDocument() override { return this; }
	///< Cast to a more defined type. Will return null not of the requested type.
